  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      if (editChallenge) {
        ...
        const response = await axios.put(`http://92.243.24.55:5000/challenges/${editChallenge.id}`, {
          ...newChallenge,
          eventId,
        });
        ...
        const allChallengeIdsResponse = await axios.get('http://92.243.24.55:5000/challenges/ids');
        ...
        const response = await axios.post('http://92.243.24.55:5000/challenges', {
          id: newId,
          eventId,
          ...newChallenge,
        });
